#!/bin/zsh
# post_merge.sh -- the D4i roster (installed by the coordinator from the agent's proposal, 2026-09-25).
#
...
set -u
cd "$(dirname "$0")/../.."             # the repository root (this file lives in tools/compare/)
